    ...
    <div className="relative overflow-hidden rounded-xl border border-zinc-800 bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-800 p-6">
      ...
      <div className="relative">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-medium text-blue-400">{currentWorkspace?.name || "Workspace"}</span>
        </div>
        ...
        <div className="mt-4 flex gap-3">
          <Link
            ...
            className="flex items-center gap-1.5 rounded-lg bg-white px-3 py-1.5 text-xs font-medium text-black hover:bg-zinc-200 transition-colors"
          >
            Search
