...
export function CommandPalette({ open, onClose, items, placeholder = "Type a command..." }: CommandPaletteProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-50 w-full max-w-xl overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-2xl animate-in fade-in-0 zoom-in-95 duration-150">
        <div className="flex items-center gap-3 border-b border-zinc-800 px-4 py-3">
          ...
          />
          <kbd className="hidden rounded-md border border-zinc-700 px-1.5 py-0.5 text-[10px] text-zinc-500 sm:block">
            ESC
          </kbd>
        </div>
              ...
              <div key={group} role="group" aria-label={group}>
                ...
                {groupItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      {item.icon && <span className="shrink-0 text-zinc-500" aria-hidden="true">{item.icon}</span>}
        ...
        <div className="flex items-center justify-between border-t border-zinc-800 px-4 py-2 text-[11px] text-zinc-600">
          ...
          <div className="flex items-center gap-3">
            <span><kbd className="rounded border border-zinc-700 px-1">&#8593;&#8595;</kbd> Navigate</span>
            <span><kbd className="rounded border border-zinc-700 px-1">&#8629;</kbd> Select</span>
            <span><kbd className="rounded border border-zinc-700 px-1">Esc</kbd> Close</span>
          </div>
        </div>
      </div>
    </div>
