...
export const relationEndpoints: Endpoint[] = [
  ...
  },
  {
    ...
    requestBody: j({
      ...
      verified: true,
      confidence: 0.95,
      ai_model: 'Qwen2.5-3B-Instruct v1',
    }),
    response: itemEnvelope({ id: relationId, workspace_id: workspaceId, source_entity_id: entityId, target_entity_id: '2cf8e8f8-b3d2-430c-883a-d68a2bf6cb8b', relation_type: 'refers_to', generated_by: 'ai', verified: true, confidence: 0.95, ai_model: 'Qwen2.5-3B-Instruct v1', relation_metadata: {}, created_by: null, created_at: '2026-06-21T08:30:00Z' }),
  },
  {
    id: 'relations-get',
    module: 'Relations',
